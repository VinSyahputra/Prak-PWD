...
class UserModel extends Model
{
    ...
    {
        // return $this->table('tb_user')->where(['level' => 1, 'nama' => $nama])->get()->getResultArray();
        return $this->db->query("SELECT * FROM tb_user WHERE level = 1 AND nama LIKE '%$nama%' ")->getResultArray();
    }
}
