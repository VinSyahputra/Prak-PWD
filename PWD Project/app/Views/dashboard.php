...
<div class="container-fluid">
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5">
            <div class="col-lg-6">
                <h1 class="mt-5 text-primary">SIPERU</h1>
                <div class="h5 text-secondary" style="font-family: Varela Round;">SISTEM INFORMASI PEMINJAMAN RUANGAN</div>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <?php foreach ($data2 as $data2) : ?>
                        <tr>
                            ...
                            <td colspan="5" class="text-primary bg-light"><b>KOSONG</b></td>
                        </tr>
                    <?php endforeach; ?>
